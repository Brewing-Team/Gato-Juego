...
public:
	...
	int CreatePath(const fPoint& origin, const fPoint& destination);

	// To request all tiles involved in the last generated path
	const DynArray<fPoint>* GetLastPath() const;
...
struct PathNode
{
	...
	PathNode();
	PathNode(int g, int h, const fPoint& pos, const PathNode* parent);
	...
	int CalculateF(const fPoint& destination);
};
...
struct PathList
{
	...
	ListItem<PathNode>* Find(const fPoint& point) const;
